...
typedef struct _SMBIOS_TYPE_INFO
{
    ...
    FIRMWARE_UTF8_STRING Name; // Type name in SMBIOS spec.
...
#define SMBIOS_DEFINE_FIELD(Type, Name, Field, FieldType) \
    { u8##Name, false, (WORD)offsetof(SMBIOS_TYPE_##Type, Field), \
      (BYTE)sizeof(((SMBIOS_TYPE_##Type*)0)->Field), FieldType, { 0, NULL } }
#define SMBIOS_DEFINE_BIT_FIELD(Name, BitOffset, BitSize, FieldType) \
    { u8##Name, true, BitOffset, BitSize, FieldType, { 0, NULL } }
#define SMBIOS_DEFINE_BIT_FIELD_ENUM(Name, BitOffset, BitSize, EnumName) \
    { u8##Name, true, BitOffset, BitSize, SmbiosDataTypeEnum, SMBIOS_FIELD_ENUM_VALUES(EnumName) }
...
#define SMBIOS_DEFINE_FIELD_ENUM(Type, Name, Field, EnumName) \
    { u8##Name, false, (WORD)offsetof(SMBIOS_TYPE_##Type, Field), \
      (BYTE)sizeof(((SMBIOS_TYPE_##Type*)0)->Field), SmbiosDataTypeEnum, SMBIOS_FIELD_ENUM_VALUES(EnumName) }
#define SMBIOS_DEFINE_FIELD_BIT(Name, BitOffset) SMBIOS_DEFINE_BIT_FIELD(Name, BitOffset, 1, SmbiosDataTypeBit)

#define SMBIOS_DEFINE_TYPE(Type, Name) \
    { Type, u8##Name, sizeof(SmbiosType##Type##FieldInfo) / sizeof(SmbiosType##Type##FieldInfo[0]), \
      SmbiosType##Type##FieldInfo }
